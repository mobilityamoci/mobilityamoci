<div class="p-7">
    ...
    <div class="text-2xl">Importazione dati scuole</div>
    <div class="mt-3 text-lg text-gray-400">Scarica il template con il pulsante "Download Template" e,
        dopo averlo compilato, caricalo e premi "Importa"
    </div>
    ...
    <form wire:submit.prevent="save" class="mt-8">
        ...
        <input class="mt-5 text-sm text-grey-500
            ...
            hover:file:text-green-700" aria-describedby="file_input_help" id="file_input" type="file"
